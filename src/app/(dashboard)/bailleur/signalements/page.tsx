    ...
    <>
      ...
      <motion.aside
        ...
        style={{
          ...
          background: "#fff",
          boxShadow: "-8px 0 48px rgba(0,0,0,.16)",
        ...
        >
          <div>
            ...
            <p className="text-xs mt-0.5" style={{ color: "#94A3B8" }}>
              #{sig.id} · {tempsRelatif(sig.date_creation)}
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="p-5 space-y-5">
            ...
            >
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-0.5">
                    <BadgeUrgence
                      urgence={sig.urgence}
                      display={sig.urgence_display}
                    />
                    <BadgeStatut
                      statut={sig.statut}
                      display={sig.statut_display}
                    />
                  </div>
                </div>
              </div>
              ...
              >
                ...
                >
                  ...
                  <span>
                    {new Date(sig.date_creation).toLocaleDateString("fr-FR", {
                      day: "numeric",
                      month: "long",
                      year: "numeric",
                      hour: "2-digit",
                ...
                {sig.date_resolution && (
                  ...
                  >
                    ...
                    <span>
                      Résolu le{" "}
                      {new Date(sig.date_resolution).toLocaleDateString(
                        "fr-FR",
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {sig.locataire.telephone && (
                  <a
                    href={`tel:${sig.locataire.telephone}`}
                ...
                <a
                  href={`mailto:${sig.locataire.email}`}
                  className="flex items-center justify-center gap-2 py-2.5 rounded-xl text-xs font-semibold"
                  style={{
                    background: "#F5F3FF",
                    color: "#7C3AED",
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        color: isActive ? s.col : "#64748B",
                        border: `2px solid ${isActive ? s.col : "#E2E8F0"}`,
                        cursor: "pointer",
                      }}
                    >
                      {s.ico} {opt.lbl}
            ...
            <div>
              ...
              />
              {sig.commentaire_resolution &&
                commentaire !== sig.commentaire_resolution && (
...
export default function BailleurSignalementsPage() {
  ...
  const load = async () => {
    ...
    try {
      const res =
        await api.get<PaginatedResponse<Signalement>>("/signalements/");
  ...
  const filtered = signalements.filter((s) => {
    ...
    const matchSearch =
      !search ||
      s.locataire.nom_complet.toLowerCase().includes(q) ||
      s.bien.titre.toLowerCase().includes(q) ||
      s.type_display.toLowerCase().includes(q) ||
  ...
  const stats = {
    ...
    resolus: signalements.filter(
      (s) => s.statut === "resolu" || s.statut === "clos",
    ).length,
  };
  ...
  return (
    <>
      ...
      >
        {/* ── Header ── */}
        <header
          className="flex items-center gap-3 px-4 sm:px-6 h-14 flex-shrink-0 bg-white"
          style={{
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="px-4 sm:px-6 pt-4 pb-8 max-w-5xl mx-auto space-y-4">
            ...
            {loading ? (
              ...
              <div
                className="flex flex-col items-center justify-center py-20 bg-white rounded-2xl text-center"
                  ...
                  >
                    <div className="flex items-stretch">
                      ...
                      <div
                        ...
                        style={{ background: URGENCE[s.urgence].dot }}
                      />
                      ...
                      <div className="flex items-center gap-3 p-4 flex-1 min-w-0">
                        ...
                        <div
                          className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0"
                          style={{
                            background: URGENCE[s.urgence].bg,
                            color: URGENCE[s.urgence].col,
                          }}
                        >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex flex-wrap items-center gap-1.5 mb-1">
                            ...
                            <BadgeUrgence
                              urgence={s.urgence}
                              display={s.urgence_display}
                            />
                            <BadgeStatut
                              statut={s.statut}
                              display={s.statut_display}
                            />
                          </div>
                          <p
                          ...
                          >
                            ...
                            <span className="flex items-center gap-1">
                              <IconUser size={11} />
                              <span>{s.locataire.nom_complet}</span>
                            </span>
                            <span className="flex items-center gap-1">
                              <IconClock size={11} />
                            ...
                            {s.date_resolution && (
                              ...
                              >
                                ...
                                <span>
                                  Résolu {tempsRelatif(s.date_resolution)}
                                </span>
                              </span>
                            )}
                          </div>
