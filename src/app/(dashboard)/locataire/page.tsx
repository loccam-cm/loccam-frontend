...
export default function LocataireDashboard() {
  ...
  const load = async () => {
    ...
    try {
      ...
      const contrat =
        cRes.data.results.find((c) => c.statut === "actif") ??
        cRes.data.results[0] ??
        null;
  ...
  const tabs = [
    ...
    {
      key: "signalements" as const,
      label: "Signalements",
      icon: <IconTool size={13} />,
    },
  ];

  const notifStyles: Record<
    string,
      ...
      >
        ...
        <aside
          ...
          style={{
            ...
            boxShadow: "4px 0 20px rgba(5,150,105,.06)",
          }}
        >
          {/* Logo */}
          <div
            ...
            <div className="flex h-full">
              ...
              <div className="flex-1 p-4 sm:p-5 overflow-y-auto min-w-0">
                ...
                >
                  ...
                  />
                  <div
                    className="absolute right-20 -bottom-6 w-24 h-24 rounded-full opacity-5"
                    style={{
                        ...
                        <>
                          ...
                          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
                            {[
                              ...
                              {
                                lbl: "Propriétaire",
                                val: contrat?.bailleur?.nom_complet ?? "—",
                              },
                            ].map((s) => (
                              <div key={s.lbl}>
                                <div
                ...
                >
                    ...
                    <div className="flex items-center gap-3 sm:gap-4 flex-shrink-0">
                      <div className="text-right">
                        <div
                          ...
                          style={{
                            color: joursRestants <= 5 ? "#DC2626" : "#D97706",
                          }}
                        >
                          Échéance
                        </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      <div
                        className="absolute inset-0 opacity-20 pr-2"
                        style={{
                          background:
                            "radial-gradient(circle at 80% 50%, #fff, transparent)",
                        }}
                        ...
                        <div className="p-4">
                          {[
                            ...
                            },
                            {
                              ...
                              col: "#2563EB",
                              title: "Quittances",
                              sub: `${data?.paiementsEffectues ?? 0} disponible(s)`,
                              url: null,
                            },
                            {
                              ico: <IconShieldCheck size={15} />,
                              bg: "#F5F3FF",
                              col: "#7C3AED",
                              title: "Attestation de location",
                              sub: "Sur demande",
                              url: null,
                            },
                            {
                          ...
                          {loading ? (
                            ...
                            (data?.messages ?? []).map((m, i) => (
                              ...
                              >
                                ...
                                {!m.est_lu && (
                                  <div
                                    className="w-2 h-2 rounded-full mt-1.5 flex-shrink-0 pulse"
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <span
                                    ...
                                    style={{
                                      background: open ? "#FFFBEB" : "#ECFDF5",
                                      color: open ? "#D97706" : "#059669",
                                    }}
                                  >
                                    {s.statut === "en_cours"
                                      ? "En cours"
