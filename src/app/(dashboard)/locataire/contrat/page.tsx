  ...
  return (
    ...
    >
      <span
        ...
        style={{ color: "#94A3B8", paddingTop: "1px" }}
      >
        {label}
      </span>
      <span
...
export default function LocataireContratPage() {
  ...
  const joursRestants = dateFin
    ? Math.max(
        0,
        Math.ceil(
          (dateFin.getTime() - maintenant.getTime()) / (24 * 3600 * 1000),
        ),
      )
    : null;
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 py-5 sm:py-6 space-y-4">
          ...
          {!loading && error && (
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <p className="text-xs mb-4" style={{ color: "#94A3B8" }}>
                Impossible de récupérer votre contrat
              </p>
              <button
                onClick={load}
          ...
          {!loading && !error && !contrat && (
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <p
                className="text-sm"
                style={{ color: "#64748B", maxWidth: "280px", lineHeight: 1.6 }}
              >
                Vous n&apos;avez pas encore de contrat de bail. Votre bailleur
                vous enverra une invitation.
              </p>
            </div>
          )}
                    ...
                    {joursRestants !== null && (
                      <div className="flex justify-end mt-1.5">
                        <span
                          ...
                          style={{
                            color: joursRestants < 30 ? "#DC2626" : "#64748B",
                          }}
                        >
                          {joursRestants === 0
                            ? "Bail expiré"
                  ...
                  <InfoRow
                    ...
                    value={
                      contrat.jour_echeance
                        ? `Le ${contrat.jour_echeance} de chaque mois`
                        : "—"
                    }
                  />
              ...
              {bien && (
                <div className="fade-up" style={{ animationDelay: ".2s" }}>
                  ...
                  >
                    ...
                    {bien.surface && (
                      <InfoRow label="Surface" value={`${bien.surface} m²`} />
                    )}
                    {bien.nb_pieces && (
                      <InfoRow
                        label="Nombre de pièces"
                        value={bien.nb_pieces.toString()}
                      />
                    )}
                    {bien.nb_chambres && (
                      <InfoRow
                        label="Chambres"
                        value={bien.nb_chambres.toString()}
                      />
                    )}
                ...
                <div className="fade-up" style={{ animationDelay: ".25s" }}>
                  ...
                  >
                    <div className="flex items-center gap-3 mb-4">
                      <div
                        className="w-12 h-12 rounded-2xl flex items-center justify-center font-bold text-base text-white flex-shrink-0"
                        style={{
                    ...
                    {bailleur.telephone && (
                      <InfoRow label="Téléphone" value={bailleur.telephone} />
                    )}
                  </Section>
                </div>
              )}
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    {
                      lbl: "Bailleur",
                      signed: contrat.signe_bailleur,
                      nom: bailleur?.nom_complet,
                    },
                    {
                      lbl: "Locataire",
                      signed: contrat.signe_locataire,
                    ...
                    <div
                      ...
                      style={{
                        ...
                        border: `1px solid ${s.signed ? "#A7F3D0" : "#E2E8F0"}`,
                      }}
                    >
                      <div
                        className="w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0"
